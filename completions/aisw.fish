...
complete -c aisw -n "__fish_aisw_using_subcommand add" -l credential-backend -d 'Where aisw stores this profile\'s managed credentials' -r -a "file system_keyring"
