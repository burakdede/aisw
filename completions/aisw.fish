...
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "add" -d 'Add a new account profile for a tool'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "use" -d 'Switch the active account for a tool'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "list" -d 'Show all profiles, optionally filtered by tool'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "remove" -d 'Remove a stored profile'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "rename" -d 'Rename a stored profile'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "status" -d 'Show current active profiles and credential status'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "init" -d 'First-run setup: shell integration and credential import'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "shell-hook" -d 'Print the shell integration hook for the given shell'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "backup" -d 'Manage credential backups'
complete -c aisw -n "__fish_aisw_using_subcommand help; and not __fish_seen_subcommand_from add use list remove rename status init shell-hook backup help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
