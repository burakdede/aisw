...
complete -c aisw -n "__fish_aisw_using_subcommand backup; and not __fish_seen_subcommand_from list restore help" -f -a "restore" -d 'Restore a backup by timestamp'
...
complete -c aisw -n "__fish_aisw_using_subcommand backup; and __fish_seen_subcommand_from help" -f -a "restore" -d 'Restore a backup by timestamp'
...
complete -c aisw -n "__fish_aisw_using_subcommand help; and __fish_seen_subcommand_from backup" -f -a "restore" -d 'Restore a backup by timestamp'
