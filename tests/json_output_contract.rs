...
fn list_json_contract_snapshot() {
    ...
    let expected = serde_json::json!({
        ...
        "codex": {
            "active": "work",
            "profiles": [{"name": "work", "auth": "api_key", "claude_auth_classification": null, "codex_auth_classification": "api_key", "label": null}],
        },
        "gemini": {
            "active": "work",
            "profiles": [{"name": "work", "auth": "api_key", "claude_auth_classification": null, "codex_auth_classification": null, "label": null}],
        }
    });
    ...
    let expected = serde_json::json!([
        {
            ...
            "compatibility_baseline": "v2.1.266",
            "stored_profiles": 1,
            "active_profile": "work",
            "auth_method": "api_key",
        ...
        "compatibility_baseline": "v0.59.0",
            "stored_profiles": 1,
            "active_profile": "work",
            "auth_method": "api_key",
            "credential_backend": "file",
...
fn list_json_contract_preserved_with_filter_and_sort_flags() {
    ...
    assert!(profile.contains_key("claude_auth_classification"));
