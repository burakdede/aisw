...
const docsKeywords = [
  ...
  'coding agent profile switch',
  'work personal client profiles',
  'repo account guardrails',
  'Anthropic account manager',
...
const DOCS = [
  {
    ...
    queries: [
      ...
      'multiple claude accounts terminal',
      'manage multiple AI coding agent accounts',
      'multiple coding agent accounts on one machine',
      'claude code work personal account',
      'how to use two claude accounts',
      'how to switch between coding agent profiles',
      'anthropic api key manager',
      'multi-account support claude code cli',
      'running multiple claude accounts without logging out',
      'how to use multiple claude code profiles on same machine',
      'CLAUDE_CONFIG_DIR multiple profiles',
      'concurrent personal work account sessions claude',
      'how to keep the right ai coding account per repo',
    ],
  },
  {
    source: 'common-situations.md',
    output: 'common-situations.md',
    ...
    queries: [
      ...
      'Gemini CLI work personal profiles',
      'coding agent account switch per repo',
      'client-specific ai coding agent accounts',
      'how to keep client and personal coding agent accounts separate',
      'desktop app account switching for claude code codex gemini',
      'verify coding agent account switch worked',
    ],
  },
  {
    ...
    queries: [
      ...
      'add second claude account cli',
      'claude code multiple profiles setup',
      'claude code authenticate multiple anthropic accounts',
      'codex profiles switch accounts without copying auth.json',
      'gemini cli account switching profiles',
    ],
  },
  {
    source: 'commands.md',
  ...
  },
  {
    ...
    description: 'Bind repos, directories, and git remotes to expected aisw contexts. Warn or block agent launches when the wrong account is active.',
    section: 'reference',
    queries: [
      'aisw workspace guardrails',
      'wrong account in wrong repo',
      'prevent wrong claude account',
      'aisw workspace bind',
      'aisw workspace guard strict',
  ...
  },
  {
    ...
    queries: [
      ...
      'aisw add --from-live',
      'how to add work account claude code',
      'store multiple anthropic api keys',
      'capture existing claude credentials',
    ],
  },
  {
  ...
  },
  {
    ...
    queries: [
      ...
      'managing multiple claude accounts consultant',
      'switching AI agents between clients',
      'coding agent account switcher for consultants',
      'claude code credentials file manual editing',
      'ai coding agent credential management',
      'local gui backend for coding agent account switching',
    ],
  },
  {
    ...
    queries: [
      ...
      'claude code credentials not switching',
      'codex cli account not changing',
      'workspace guard blocked launch',
    ],
  },
];
