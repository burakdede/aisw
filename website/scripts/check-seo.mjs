...
async function main() {
  ...
  assertContains(indexHtml, 'Current release: v0.1.0.', 'release-aware hero tagline');
  ...
  assertContains(llmsFull, 'Current version: 0.1.0', 'llms-full current version');
  ...
  assertContains(versionJson, '"version": "0.1.0"', 'version metadata artifact');
}
