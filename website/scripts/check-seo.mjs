...
async function main() {
  ...
  assertContains(indexHtml, 'Current release: v0.1.1.', 'release-aware hero tagline');
  ...
  assertContains(llmsFull, 'Current version: 0.1.1', 'llms-full current version');
  ...
  assertContains(versionJson, '"version": "0.1.1"', 'version metadata artifact');
}
