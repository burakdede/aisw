...
head:
  ...
  - tag: meta
    attrs:
      name: keywords
      content: aisw, AI Switcher, AI CLI account switcher, Claude Code, Codex CLI, Gemini CLI, multi-account CLI, developer tooling, Configuration, reference, aisw config.json, aisw configuration file
  - tag: meta
    attrs:
