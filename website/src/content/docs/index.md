...
hero:
  title: "aisw"
  tagline: "AI / Coding Agent account manager and switcher for Claude Code, Codex CLI, and Gemini CLI. Current release: v0.2.0."
  actions:
    - text: Quickstart
