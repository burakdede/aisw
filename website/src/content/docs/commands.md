...
head:
  ...
  - tag: meta
    attrs:
      name: keywords
      content: aisw, AI CLI account switcher, Claude Code, Codex CLI, Gemini CLI, multi-account CLI, developer tooling, Commands, reference, aisw command reference, aisw add use list status
  - tag: meta
    attrs:
