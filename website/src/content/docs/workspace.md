...
editUrl: https://github.com/burakdede/aisw/edit/main/docs/workspace.md
head:
  - tag: meta
    attrs:
      name: robots
...
- [Commands](/aisw/commands/) - full flag reference including `workspace check`
- [Shell integration](/aisw/shell-integration/) - how the prompt check and agent wrappers work
- [Quickstart](/aisw/quickstart/) - getting started with profiles and contexts
