...
A repo can also carry its own binding at `<repo>/.git/info/aisw.json`, which takes precedence over these user-level rules. See [Workspace guardrails](workspace.md).
